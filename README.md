...
* 장바구니 처리에 대한 비즈니스 로직은 기본적인 형태만 유지하며 데이터 관리는 별도 저장이 없는 휘발성입니다.<br><br>
* 이 샘플의 핵심은 전반적인 AAC와 범용적인 라이브러리들을 이용하여 Rest api를 다루는 온라인 서비스에서 데이터의 페이징 처리의 효율적인 구현 방법론에 대한 샘플 소스 공유입니다.
